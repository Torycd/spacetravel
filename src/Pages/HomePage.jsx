  ...
  return (
    <div className="text-white flex flex-col m-2 sm:flex-row justify-between">
      <div className="flex flex-col gap-8 sm:ml-10 sm:my-40">
        <p className="font-normal sm:text-3xl">So, you want to travel to</p>
        <h2 className="sm:text-9xl text-7xl font-bold">Space</h2>
      ...
      <div className="sm:w-64 sm:h-64 w-32 h-32 flex items-center justify-center mt-10 rounded-full my-auto mx-auto bg-white sm:ml-40  sm:mr-60">
