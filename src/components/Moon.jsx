  ...
  return (
    <div className="flex flex-col lg:justify-normal gap-5 lg:gap-10 text-left mt-5 lg:mt-20">
      ...
      <p className="flex justify-center lg:justify-normal">
        See our planet as youve never seen it before.
        <br /> A perfect relaxing trip away to help regain perspective and
        <br /> come back refreshed. While youre there, take in some history by
        visiting
        <br /> the Luna 2 and Apollo 11 landing sites.
      </p>
